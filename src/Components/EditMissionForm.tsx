...
import { filterSubMissionsFromLink, getLinkToMissionOptions, getMissionsExceptLowestHierarchy } from "../Logic/SubMissionLogic";
...
export const EditMissionForm: React.FC = () => {
    ...
    filterSubMissionsFromLink(missions, 1);
